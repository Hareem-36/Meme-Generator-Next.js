...
export default function MemeGenerator() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-lime-200 to-lime-200">
      <div className="max-w-4xl w-full px-4 py-8 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-center space-y-8">
          {/* Header section */}
          <div className="text-center space-y-2">
            <u><h1 className="text-4xl font-bold tracking-tight sm:text-5xl text-blue-900">
              Meme Generator
            </h1></u>
           <br></br> <b><p className="text-muted-foreground text-blue-950">
